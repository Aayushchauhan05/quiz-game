...
function App() {
  ...
  const data = [
    ...
    {
      id: 9,
      question: "which one of them is anime series",
      answers: [
        {
          text: "AOT",
          correct: false,
    ...
    {
      id: 12,
      question: "who scored 100 century in cricket",
      answers: [
        {
          text: "sachin tendulkar",
          correct: true,
    ...
    {
      id: 14,
      question: "which trophy won most odi world cups",
      answers: [
        {
          text: "india",
          correct: false,
